...
import { AddArticleSchema } from '../../_components/author/article-table/article-schema';
...
export default function AdminUpdateArticle() {
  ...
  useEffect(() => {
    authorFn.getData(TabEnum.CATEGORIES);
  }, []);
            ...
            <Controller
              ...
              render={({ field: { onChange, onBlur, value, ref } }) => (
                <Select onValueChange={onChange} defaultValue={value}>
                  ...
                  <SelectContent>
                    <SelectGroup>
                      {authorState.contents.categories.map((category) => (
        ...
        <div className="flex flex-col">
          ...
          <div className="flex-1 bg-white rounded-lg p-6 mt-2">
            <div className="text-center font-black uppercase text-sm tracking-widest text-icp-yellow">
              {authorState.contents.categories.find((c) => c.id === watchCat)?.name}
            </div>
